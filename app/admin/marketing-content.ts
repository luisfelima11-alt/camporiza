...
export const CONTENT: ContentPiece[] = [
  ...
  {
    id: '2026-10-06-area-pequena', title: 'A partir de 1 hectare', format: 'Carrossel 3:4',
    pillar: 'Área pequena', cover: 'field', headline: 'A partir de 1 hectare', initialStatus: 'revisao', plannedDate: '06/10/2026',
    assetUrl: 'https://drive.google.com/drive/folders/1lsfRnv9ccwHOs7ZL9T2cgftRSFsNv_o3', assetLabel: 'Abrir artes e legenda no Drive',
    previewImage: '/marketing/planejados/2026-10-06/01-capa-final.png',
    assets: [
      { src: '/marketing/planejados/2026-10-06/01-capa-final.png', label: '01 · A partir de 1 hectare', format: 'Feed 3:4' },
      { src: '/marketing/planejados/2026-10-06/02-avaliacao-final.png', label: '02 · Cada área pede avaliação', format: 'Feed 3:4' },
      { src: '/marketing/planejados/2026-10-06/03-orcamento-final.png', label: '03 · Vamos entender sua área?', format: 'Feed 3:4' },
    ],
    objective: 'Convidar produtores de áreas menores a pedir orçamento sem prometer disponibilidade ou resultado antes da avaliação.',
    direction: 'Três telas prontas para aprovação. Fotografia ilustrativa gerada no Higgsfield; texto e logo oficial aplicados no acabamento. Data sugerida, sem agendamento no Instagram.',
    caption: 'Sua área tem a partir de 1 hectare? Ela também entra na conversa. 🌱\n\nNa Camporiza, o orçamento começa entendendo a propriedade: cultura, localização, acesso, condições da área e serviço necessário. Cada situação pede avaliação antes de confirmar o atendimento.\n\nPara conversar com a equipe, envie seu município, cultura, área em hectares e o que você precisa.\n\n📲 WhatsApp no perfil: https://wa.me/5567996330973\n\nCamporiza. Na hora certa. No lugar certo.\n\n#Camporiza #DroneAgrícola #ProdutorRural #AgroMS\n\nImagem ilustrativa criada com IA.',
    script: ['01 · A partir de 1 hectare: áreas menores também entram na conversa.', '02 · Serviço, localização e condições da área orientam a avaliação.', '03 · Enviar município, cultura, hectares e serviço pelo WhatsApp do perfil.'],
  },
  {
    ...
    objective: 'Estimular avaliação técnica de um sinal na cultura antes de decidir se alguma aplicação é necessária.',
    direction: 'Arte e legenda prontas para aprovação. Cena ilustrativa gerada no Higgsfield; não representa diagnóstico, propriedade ou cliente real. Data sugerida, sem agendamento no Instagram.',
    caption: 'Viu um sinal diferente na lavoura? Observar é o primeiro passo — mas um sinal sozinho não fecha um diagnóstico. 🌱\n\nAntes de qualquer aplicação, é importante identificar o problema e avaliar a cultura e as condições da área com orientação técnica. Se a pulverização for indicada, converse com a Camporiza sobre as possibilidades de atendimento.\n\n📲 WhatsApp no perfil: https://wa.me/5567996330973\n\nCamporiza. Na hora certa. No lugar certo.\n\n#Camporiza #DroneAgrícola #ManejoResponsável #AgroMS\n\nImagem ilustrativa criada com IA.',
    script: ['Post estático em 1080 × 1440.', 'Não apresentar a folha ilustrativa como diagnóstico real.', 'Aprovar arte e legenda antes de publicar.'],
  },
  {
